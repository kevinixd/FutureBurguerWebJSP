<%-- 
    Document   : snacks
    Created on : Aug 23, 2019, 1:06:38 PM
    Author     : javam2019
--%>
...
<html lang="es">
    ...
    <div class="row container-fluid  alto100 animated zoomIn">
        ...
        <body class="border">
            <%
                ArrayList<Productos> lista = (ArrayList) request.getAttribute("listaSnacks");
                int tam = lista.size();
                int cant = 0;
            %>
            <!--Contenedor para snacks-->
            <div class="row container-fluid  alto100 animated zoomIn">
                <div class="align-self-center col-12 col-sm-12" id="snacks">
                        ...
                        <div class="align-items-center col-<%= cant%>" >
                            <div class=" cardmain" style="width: 200px;">
                                <a href="Javascript: cargar('#productos', '');">
                                    <img src="img/snacks/<%= elem.getImagen() %>" class="card-img-top main">
                                    <div class="card-body">

        ...
        <div class="row container-fluid border alto100 animated zoomIn">
            <div class="align-self-center col-12 col-sm-12" id="combo1">
                    ...
                    <div class="row col-12 col-sm-12 align-self-center">
                        <div class="align-items-center col-6 col-sm-6" id="combo2">
                            <div class=" cardmain" style="width: 200px;">
                                <img src="img/combos/20.png" class="card-img-top main">
                                <div class="card-body">
                        ...
                        <div class="align-items-center col-6 col-sm-6" id="hamburguesa2">
                            <div class=" cardmain" style="width: 200px;">
                                <img src="img/hamburguesas/2002.png" class="card-img-top main">
                                <div class="card-body">
                                    <p class="card-text text-center font-weight-bold text-primary text-decoration-none">
                                        Hmaburguesas 4 Fantasticos</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-center">
                    ...
                    <br>
                    <br>
                    <a href="Javascript:cargar('#productos','pags/combos/almuerzos.jsp');"><button type="button"

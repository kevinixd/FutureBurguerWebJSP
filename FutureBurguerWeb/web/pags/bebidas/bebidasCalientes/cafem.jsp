<%-- 
    Document   : cafem
    Created on : Aug 26, 2019, 9:55:08 AM
    Author     : javam2019
--%>
...
<html lang="es">
    ...
    <body class="border">
        ...
        <div class="row container-fluid border alto100 animated zoomIn">
            ...
            <div class="align-self-center col-12 col-sm-12" id="cafem">
                <br>
                <br>
                ...
                <div class=" col-sm-12  ">
                    ...
                    <p class="card-text text-center font-weight-bold text-primary text-decoration-none h2">Cafe Mediano</p>
                ...
                <p class="card-text text-center h3"><br>Precio: Q11.00</p>
                <br>
                <br>
                <div class=" text-center">

                    <a href="Javascript:cargar('#productos','pags/bebidas/bebidasCalientes/bebidacafe.html');"><button type="button"
                                                                                                                       class="btn btn-outline-danger btn-lg">Regresar A Bebida Cafe!
                        </button></a>
